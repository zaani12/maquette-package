                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <div class="float-sm-right">
                                <a href="./view/projets/create.php" class="btn btn-info">
                                    ...
                                    <table class="table table-striped text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <a href="/view/taches/index.php" class="btn btn-sm btn-secondary mx-2"><i class="nav-icon fas fa-tasks"></i> Les Tâches</a>
                                                    <a href="/view/projets/show.php" class='btn btn-default btn-sm'>
                                                        <i class="far fa-eye"></i>
                                                    </a>
                                                    <a href="/view/projets/edit.php" class="btn btn-sm btn-default"><i class="fa-solid fa-pen-to-square"></i></a>
